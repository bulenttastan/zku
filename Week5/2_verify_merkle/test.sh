...
cd ..
#
snarkjs groth16 setup merkle.r1cs ../powersOfTau28_hez_final_14.ptau merkle_0000.zkey
echo "test" | snarkjs zkey contribute merkle_0000.zkey merkle_final.zkey --name="1st Contributor Name" -v
snarkjs zkey verify merkle.r1cs ../powersOfTau28_hez_final_14.ptau merkle_final.zkey
