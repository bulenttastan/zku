...
cd ..
#
snarkjs groth16 setup single_tx.r1cs ../powersOfTau28_hez_final_14.ptau single_tx_0000.zkey
echo "test" | snarkjs zkey contribute single_tx_0000.zkey single_tx_final.zkey --name="1st Contributor Name" -v
snarkjs zkey verify single_tx.r1cs ../powersOfTau28_hez_final_14.ptau single_tx_final.zkey
